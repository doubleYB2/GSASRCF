...
function [results] = ASRCF_optimized2(params)
...
yf           = fft2(y); %   FFT of y.
M = generate_gaussian_mask(use_sz, base_target_sz, featureRatio, params);
...
% ADMM solution    
   ...
   % ADMM solution for localization
    [g_f,h_f]=ADMM_solve_h1(params,use_sz,model_xf,yf,small_filter_sz,w,model_w,frame,M);
   ...
   % ADMM solution for scale estimation
    [g_hcf]=ADMM_base1(params,use_sz,model_xhcf,xhcf,yf,small_filter_sz,frame);
